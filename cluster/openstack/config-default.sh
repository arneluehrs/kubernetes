...
# Shared
KUBE_IMAGE="${KUBE_IMAGE-a7f741b7-5c1f-494b-9f11-6c2b06b7ad2f}" # CoreOS
SSH_KEY_NAME="${SSH_KEY_NAME-id_kubernetes}"
NOVA_NETWORK_LABEL="kubernetes"
NOVA_NETWORK_CIDR="${NOVA_NETWORK-192.168.0.0/24}"
INSTANCE_PREFIX="kubernetes"

# Master
KUBE_MASTER_FLAVOR="${KUBE_MASTER_FLAVOR-standard.small}"
MASTER_NAME="${INSTANCE_PREFIX}-master"
MASTER_TAG="tags=${INSTANCE_PREFIX}-master"

# Minion
KUBE_MINION_FLAVOR="${KUBE_MINION_FLAVOR-standard.medium}"
OPENSTACK_NUM_MINIONS="${OPENSTACK_NUM_MINIONS-4}"
MINION_TAG="tags=${INSTANCE_PREFIX}-minion"
MINION_NAMES=($(eval echo ${INSTANCE_PREFIX}-minion-{1..${OPENSTACK_NUM_MINIONS}}))
KUBE_NETWORK=($(eval echo "10.240.{1..${OPENSTACK_NUM_MINIONS}}.0/24"))
